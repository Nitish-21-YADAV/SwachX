...
AGENCIES = [
    ...
    *[{"pincode":str(p),"agency":"BMC","city":"Mumbai","email":"info@bmc.gov.in"}         for p in range(400001,400108)],
    # NMMC Navi Mumbai
    *[{"pincode":str(p),"agency":"NMMC","city":"Navi Mumbai","email":"info@nmmconline.com"}
    ...
    # TMC Thane
    *[{"pincode":str(p),"agency":"TMC","city":"Thane","email":"mc@thanecity.gov.in"}
      for p in [400601,400602,400603,400604,400605,400606,400607,400608,400610,400612,400615,400616,400617]],
    # KDMC Kalyan-Dombivli
    *[{"pincode":str(p),"agency":"KDMC","city":"Kalyan-Dombivli","email":"kdmcgad@gmail.com"}
    ...
    *[{"pincode":str(p),"agency":"NMC Nagpur","city":"Nagpur","email":"mconagpur@gov.in"}   for p in range(440001,440037)],
    # NMC Nashik
    *[{"pincode":str(p),"agency":"NMC Nashik","city":"Nashik","email":"commissioner@nmc.gov.in"} for p in range(422001,422022)],
    # Satara
    *[{"pincode":str(p),"agency":"SMC Satara","city":"Satara","email":"sataramunicipal@gmail.com"}
      for p in [415001,415002,415003,415004,415005,415010,415011,415012,415015,415020]],
    # Sangli
    *[{"pincode":str(p),"agency":"SMKC Sangli","city":"Sangli","email":"smkcorporation@gmail.com"}
      for p in [416416,416410,416411,416412,416413,416414,416415,416301,416302,416303,416304,416305]],
    # Kolhapur
    *[{"pincode":str(p),"agency":"KMC Kolhapur","city":"Kolhapur","email":"info@kolhapurcorporation.org"}
