...
export default function Landing() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-base)' }}>
      ...
      {/* Hero */}
      <section style={{
        background: 'radial-gradient(ellipse at 15% 60%, rgba(200,241,53,0.07) 0%, transparent 55%), radial-gradient(ellipse at 85% 20%, rgba(139,184,32,0.05) 0%, transparent 45%), var(--bg-base)',
        ...
        <div className="page-wrapper" style={{ position:'relative', textAlign:'center' }}>
          ...
          <h1 className="heading mb-6" style={{ fontSize:'clamp(2.8rem,7vw,5rem)', lineHeight:1.05, color:'var(--text-1)' }}>
            Report Waste.<br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {STEPS.map(({ num, title, desc }) => (
              <div key={num} className="card card-glow p-6">
                <div className="heading mb-3" style={{ fontSize:'3rem', color:'rgba(200,241,53,0.15)', lineHeight:1 }}>
                  {num}
                </div>
